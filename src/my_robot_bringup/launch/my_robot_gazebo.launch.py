...
def generate_launch_description():
    ...
    gazebo = IncludeLaunchDescription(
        ...
        launch_arguments={"gz_args": [f"-r {path_world_file}"]}.items())
    ...
    declare_slam_launch_params = DeclareLaunchArgument(
        "slam_params_file",
    ...
    declare_nav2_launch_params = DeclareLaunchArgument(
        "nav2_params_file",
    ...
    launch_description_object.add_action(gazebo)
    launch_description_object.add_action(spawn_entity)
    launch_description_object.add_action(bridge)
    launch_description_object.add_action(declare_slam_launch_params)
    launch_description_object.add_action(slam_toolbox_launch)
    launch_description_object.add_action(declare_nav2_launch_params)
